...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public voteLottoAddress;
    bytes32 public keyHash;
    bytes32 public latestRequestId;
    uint32 public randomResult;
    uint256 public fee;
    uint256 public latestLottoId;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == voteLottoAddress, "!VoteLotto");
        require(keyHash != bytes32(0), "!Valid key hash");
        require(LINK.balanceOf(address(this)) >= fee, "!Link Funds");
    ...
    /**
     * @notice Set the address for the GrimVoteLotto
     * @param _voteLotto: address of the PancakeSwap lottery
     */
    function setLottoAddress(address _voteLotto) external onlyOwner {
        voteLottoAddress = _voteLotto;
    }
    ...
    /**
     * @notice View latestLottoId
     */
    function viewLatestLottoId() external view override returns (uint256) {
        return latestLottoId;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLottoId = IVoteLotto(voteLottoAddress).getCurrentLottoId();
    }
}